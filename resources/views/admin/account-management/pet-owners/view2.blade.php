    ...
    <div class="container">
        <div class="row">
            <div class="col-md-9">
                ...
                <ul class="l-menu">
                    <li>
                        <a href="{{ URL::to('/admin/account-management/pet-owners/view') }}">Mochi</a>
                    </li>
                    <li>
                        <a class="active" href="{{ URL::to('/admin/account-management/pet-owners/view2') }}">Donut</a>
                    </li>
                </ul>
                <div class="box-profile">
                    <div class="tbl">
                        <div class="cell img">
                            <div class="bdr">
                                <img src="{{ asset('assets/img/admin/profile-dog.png') }}" alt="" title="">
                            </div>
                        </div>
                        <div class="cell">
