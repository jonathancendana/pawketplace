                    ...
                    <div class="form-faq">
                        ...
                        <div class="mb15">
                            <div class="tbl">
                                ...
                                <div class="cell">
                                    <input value="This is question 1" type="text" class="form-control" name="" required/>
                                </div>
                            </div>
                        </div>
                        <div>
                            <div class="tbl">
                                ...
                                <div class="cell">
                                    <textarea type="message" class="form-control" name="" required>This is answer for question 1</textarea>
                                </div>
                            </div>
                        </div>
                    </div>
                    <div class="form-faq">
                        ...
                        <div class="mb15">
                            <div class="tbl">
                                ...
                                <div class="cell">
                                    <input value="This is question 2" type="text" class="form-control" name="" required/>
                                </div>
                            </div>
                        </div>
                        <div>
                            <div class="tbl">
                                ...
                                <div class="cell">
                                    <textarea type="message" class="form-control" name="" required>This is answer for question 2</textarea>
                                </div>
                            </div>
                        </div>
                    </div>
                    <div class="form-faq">
                        ...
                        <div class="mb15">
                            <div class="tbl">
                                ...
                                <div class="cell">
                                    <input value="This is question 3" type="text" class="form-control" name="" required/>
                                </div>
                            </div>
                        </div>
                        <div>
                            <div class="tbl">
                                ...
                                <div class="cell">
                                    <textarea type="message" class="form-control" name="" required>This is answer for question 3</textarea>
                                </div>
                            </div>
                        </div>
                    </div>
                    <div class="form-faq">
                        ...
                        <div class="mb15">
                            <div class="tbl">
                                ...
                                <div class="cell">
                                    <input value="This is question 4" type="text" class="form-control" name="" required/>
                                </div>
                            </div>
                        </div>
                        <div>
                            <div class="tbl">
                                ...
                                <div class="cell">
                                    <textarea type="message" class="form-control" name="" required>This is answer for question 4</textarea>
                                </div>
                            </div>
                        </div>
                    </div>
                    <div class="form-faq">
                        ...
                        <div class="mb15">
                            <div class="tbl">
                                ...
                                <div class="cell">
                                    <input value="This is question 5" type="text" class="form-control" name="" required/>
                                </div>
                            </div>
                        </div>
                        <div>
                            <div class="tbl">
                                ...
                                <div class="cell">
                                    <textarea type="message" class="form-control" name="" required>This is answer for question 5</textarea>
                                </div>
                            </div>
                        </div>
                    </div>
        ...
        newForm.innerHTML = `
            ...
            <div class="mb15">
                <div class="tbl">
                    ...
                    <div class="cell"><input type="text" class="form-control" required/></div>
                </div>
            </div>
            <div>
                <div class="tbl">
                    <div class="cell w100"><div class="t2-faq">Answer</div></div>
                    <div class="cell"><textarea class="form-control" required></textarea></div>
                </div>
            </div>
        `;
