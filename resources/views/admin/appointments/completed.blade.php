        ...
        <div class="row justify-content-center">
            <div class="col-md-7">
                ...
                <div class="form-group">
                    ...
                    <div class="text">Diagnosis from vet goes here...</div>
                </div>
                <div class="box-audit mt0">
                    <div class="t1">Audit trail</div>
                    <div class="mb10">
                        <div class="tbl">
                            <div class="cell w150">28 Nov 2024, 2:30PM</div>
                            <div class="cell">The Gentle Vet (V00012) marked appointment as Completed</div>
                        </div>
                    </div>
                    <div class="mb10">
                        <div class="tbl">
